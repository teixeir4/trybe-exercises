...
function addTech(event) {
    ...
    if (idClicked === 'first-li') {
        firstLi.classList = 'tech';
        secondLi.classList = '';
        thirdLi.classList = '';
    } else if (idClicked === 'second-li') {
        firstLi.classList = '';
        secondLi.classList = 'tech';
        thirdLi.classList = '';
    } else if (idClicked === 'third-li') {
        firstLi.classList = '';
        secondLi.classList = '';
...
input.addEventListener('input', function(event) {
    let textChange = document.querySelector('.tech');
...
myWebpage.addEventListener('dblclick', function() {
    window.location.replace('https://teixeir4.github.io')
});
